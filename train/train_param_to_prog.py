...
#%%
trainer = TrainerModule('temp_PARAM_7_medium_masking_ordering',#'no mean shuffled inputs pose in hid',#f'11 big lr: {LEARNING_RATE} bs: {batch_size} epcs: {max_epochs}', 
                        next(it), 
                        num_train_iters, 
                        dataset=src_dataset, 
                        lr=LEARNING_RATE,
